...
export class Lexer {
  ...
  /**
   * Lexer class for Scrapeium
   * @param source the query to be lexed
   */
  ...
  /**
   * Reads in a character (or characters) from the query string and returns the accossiated token
   * @returns An individual token
   */
