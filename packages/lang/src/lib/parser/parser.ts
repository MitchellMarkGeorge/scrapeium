...
export class Parser {
  ...
  /**
   * Parser class for Scrapeium
   * @param source the query to be parsed
   */
  ...
  /**
   * Parses a query and returns an AST of the query
   * @returns the root node in the AST
   */
  ...
  private parseStatement(): Statement {
    switch (this.currentToken.type) {
      ...
      default:
        throw new ParserError(
          `Expected statement; Found ${this.currentToken.type}`,
          this.currentToken.lineNumber
        );
    }
  }
